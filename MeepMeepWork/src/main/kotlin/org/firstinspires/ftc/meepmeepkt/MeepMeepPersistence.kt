package org.firstinspires.ftc.meepmeepkt
...
class MeepMeepPersistence @JvmOverloads constructor(
    ...
    fun save(path: String = defaultFilePath) {
        ...
        properties.setProperty("windows_x", meepMeep.windowFrame.x.toString())
        properties.setProperty("windows_y", meepMeep.windowFrame.y.toString())
    ...
    fun restore() {
        ...
        meepMeep.windowFrame.setLocation(
            properties.getProperty("windows_x", "0").toInt(),
            properties.getProperty("windows_y", "0").toInt()
        )
    }
