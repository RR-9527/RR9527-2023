package org.firstinspires.ftc.teamcodekt.components.deadwheels
 ...
 */
class Deadwheels {
    var left: org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel by LateInitVal()
    var right: org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel by LateInitVal()
    var back: org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel by LateInitVal()

    fun logData(telemetry: Telemetry, dataSupplier: DataSupplier<org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel>) {
...
fun initializedDeadwheels(motors: DriveMotors) = Deadwheels().apply {
    left  = org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel(motors.backRight)
    right = org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel(motors.frontLeft)
    back  = org.firstinspires.ftc.teamcodekt.components.deadwheels.Deadwheel(motors.frontRight)
}