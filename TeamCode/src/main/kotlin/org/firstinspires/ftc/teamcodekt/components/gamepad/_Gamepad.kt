package org.firstinspires.ftc.teamcodekt.components.gamepad
 ...
 * ```
 *
 * @param deadzone Minimum joystick offset to be considered "triggered"; defaults to `0.1`
 *
 * @return `true` if any of the joysticks are triggered
 */
@JvmOverloads
fun Gamepad.isJoystickTriggered(deadzone: Double = .1) =
 ...
 */
fun Gamepad.getDriveSticks() = listOf(-left_stick_y, left_stick_x, right_stick_x)